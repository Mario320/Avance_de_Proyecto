...
document.getElementById("Comentarios").appendChild(comentario);
		...
		var alerta1 = document.getElementById("campito");
		var alerta2 = document.getElementById("hola3");
	alerta2.innerHTML = "Campo Requerido";
	alerta2.style.color = "red";
	alerta1.innerHTML = "Ingrese solo letras";
